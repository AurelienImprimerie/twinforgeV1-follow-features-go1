        ...
        <div className="space-y-6 flex flex-col items-center">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-3">
              Commencez votre suivi nutritionnel
            </h2>
            <p className="text-white/70 text-lg">
              Scannez votre premier repas pour obtenir une analyse IA complète
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
            <div className="text-center space-y-3">
              ...
              <p className="text-white/60 text-sm">
                Prenez simplement une photo de votre assiette
              </p>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-white/60 text-sm">
                Détection automatique des aliments et calcul nutritionnel
              </p>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold text-white">Tracking et tendances</h3>
              <p className="text-white/60 text-sm">
          ...
          >
            <div className="flex items-center justify-center gap-2">
              ...
              />
              <span>
                Astuce : Photographiez votre assiette avant de manger pour une analyse optimale !
              </span>
            </div>
          </div>
        </div>
...
export default EmptyMealsScannerState;
