...
const EmptyMealHistoryState: React.FC = () => {
        ...
        <div className="space-y-6 flex flex-col items-center">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-3">
              Démarrez votre journal nutritionnel
            </h2>
            <p className="text-white/70 text-lg">
              Scannez vos premiers repas pour construire votre historique
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
            <div className="text-center space-y-3">
              ...
              <p className="text-white/60 text-sm">
                Tous vos repas archivés et accessibles
              </p>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold text-white">Recherche avancée</h3>
              <p className="text-white/60 text-sm">
                Retrouvez facilement vos repas passés
              </p>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold text-white">Analyses rétroactives</h3>
              <p className="text-white/60 text-sm">
          ...
          <div className="pt-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-lg">Scanner mon premier repas</span>
              </div>
          ...
          >
            <div className="flex items-center justify-center gap-2">
              ...
              />
              <span>
                Astuce : Scannez régulièrement vos repas pour des insights nutritionnels plus précis !
              </span>
            </div>
          </div>
        </div>
...
export default EmptyMealHistoryState;
