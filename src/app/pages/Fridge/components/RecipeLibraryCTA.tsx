...
const RecipeLibraryCTA: React.FC = () => {
  ...
  const handleGenerateClick = () => {
    click();
    navigate('/fridge/generate-recipes');
  };
  ...
  return (
    <GlassCard
      ...
      style={{
        background: `
          radial-gradient(circle at 30% 20%, color-mix(in srgb, #10B981 20%, transparent) 0%, transparent 60%),
          radial-gradient(circle at 70% 80%, color-mix(in srgb, #34D399 18%, transparent) 0%, transparent 50%),
          radial-gradient(circle at 50% 50%, color-mix(in srgb, #059669 15%, transparent) 0%, transparent 70%),
        ...
        boxShadow: `
          ...
          0 0 80px color-mix(in srgb, #34D399 25%, transparent),
    ...
    >
        ...
        {[0, 1, 2, 3].map((i) => (
          <MotionDiv
            ...
            style={{
              ...
              height: '12px',
              borderRadius: '2px',
              background: 'linear-gradient(135deg, #10B981, rgba(52, 211, 153, 0.8))',
      ...
      <div className="relative z-10 space-y-8">
          ...
          <MotionDiv
            ...
            style={{
              background: `
                ...
                radial-gradient(circle at 70% 70%, color-mix(in srgb, #10B981 20%, transparent) 0%, transparent 50%),
        ...
        >
          ...
          >
            Générer Nouvelles Recettes
          </h2>
          <p className="text-white/85 text-lg leading-relaxed max-w-2xl mx-auto">
            Créez des recettes personnalisées basées sur votre inventaire.
            La Forge Spatiale adapte chaque recette à vos goûts et contraintes alimentaires.
          </p>
        </MotionDiv>
        ...
        >
          <button
            ...
            style={{
              ...
              boxShadow: `
                0 20px 50px color-mix(in srgb, #10B981 45%, transparent),
            ...
            onMouseEnter={(e) => {
              if (!isPerformanceMode && window.matchMedia('(hover: hover)').matches) {
                ...
                e.currentTarget.style.boxShadow = `
                  0 24px 60px color-mix(in srgb, #10B981 55%, transparent),
        ...
        >
          {[
            { icon: ICONS.Sparkles, label: 'IA Personnalisée', color: '#10B981' },
            { icon: ICONS.Clock, label: 'Rapide', color: '#34D399' },
            { icon: ICONS.Check, label: 'Zéro Gaspillage', color: '#059669' }
          ].map((stat, index) => (
            <MotionDiv
              key={index}
...
export default RecipeLibraryCTA;
